...
public class TestGUI49 {
    public static void main(String[] args) {
        ...
        //为工具栏增加按钮
        JButton b1 = new JButton(new ImageIcon("/Users/apple/Downloads/编程素材/images/1.jpg"));
        JButton b2 = new JButton(new ImageIcon("/Users/apple/Downloads/编程素材/images/2.jpg"));
        JButton b3 = new JButton(new ImageIcon("/Users/apple/Downloads/编程素材/images/3.jpg"));
        JButton b4 = new JButton(new ImageIcon("/Users/apple/Downloads/编程素材/images/4.jpg"));
        JButton b5 = new JButton(new ImageIcon("/Users/apple/Downloads/编程素材/images/5.jpg"));
        JButton b6 = new JButton(new ImageIcon("/Users/apple/Downloads/编程素材/images/6.jpg"));
        tb.add(b1);
        tb.add(b2);
        tb.add(b3);
        tb.add(b4);
